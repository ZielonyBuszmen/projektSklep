...
// lokalnie jest to baza: projektsklep
    ...
    or die('Brak polaczenia z serwerem MySQL.<br />Blad: '.mysql_error().'<hr><hr><a href="baza/instrukcja.php">Przejdz do strony z instrukcjami</a>');

    // wybieramy odpowiednią bazę danych
    $db = @mysql_select_db($nazwa_bazy, $connection)
    or die('Nie moge polaczyc sie z baza danych<br />Blad: '.mysql_error().'<hr><hr><a href="baza/instrukcja.php">Przejdz do strony z instrukcjami</a>');
